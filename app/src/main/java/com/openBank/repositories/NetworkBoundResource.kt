...
import com.openBank.network.ApiEmptyResponse
import com.openBank.network.ApiErrorResponse
import com.openBank.network.ApiResponse
import com.openBank.network.ApiSuccessResponse

/**
 * A generic class that can provide a resource backed by both the local (i.e. sqlite database)
 * and the network.
 *
 *
